...
short CalculateRepeationOfItemAtArray(short arr[3][3],short number, short rows, short columns)
{
    short Calculator = 0 ;
...
void printRepeationOfItemResult(short repeationTimes ,short number)
{
    if (repeationTimes > 0) {
        cout << "\n\t\tthe number " << number << " repeated " << repeationTimes << " times in array.\n";
    }
    else 
    {
        cout << "\n\t\tthe number " << number << " is unfound in current array.\n";
    }
}
